...
async function startHaruka() {
	...
	const sock = makeWASocket({
		...
		version: (await (await fetch('https://raw.githubusercontent.com/WhiskeySockets/Baileys/master/src/Defaults/baileys-version.json')).json()).version, //{"version": [2, 3000, 1020608496]}
